...
courses = {
    ...
    "프랑스": {
        ...
        "recommendations": [
            {"title": "프랑스 미술사 탐구", "desc": "인상주의부터 현대미술까지 흐름 이해", "link": "https://example.com/france1", "category": "예술"},
    ...
    "이탈리아": {
        ...
        "recommendations": [
            {"title": "이탈리아 르네상스 미술", "desc": "다빈치와 미켈란젤로를 중심으로", "link": "https://example.com/italy1", "category": "예술"},
    ...
    "중국": {
        ...
        "recommendations": [
            ...
            {"title": "중국 서예 체험", "desc": "붓글씨를 통한 예술적 감각 배우기", "link": "https://example.com/china2", "category": "예술"}
        ]
    },
    "멕시코": {
